#include "main.hpp"
Napi::Object Libtorrent::TorrentFlags::DefaultFlags(Napi::Env env)
{
    libtorrent::torrent_flags_t *torrent_flags_t = new libtorrent::torrent_flags_t(libtorrent::torrent_flags::default_flags);
